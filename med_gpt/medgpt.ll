; ModuleID = 'med_gpt/medgpt.c'
source_filename = "med_gpt/medgpt.c"
...
define noundef i32 @main() local_unnamed_addr #3 {
  ...
  call void @memset_pattern16(ptr %4, ptr nonnull @.memset_pattern.7, i64 262144), !tbaa !9
  %5 = call dereferenceable_or_null(1048576) ptr @malloc(i64 noundef 1048576) #10
  call void @memset_pattern16(ptr %5, ptr nonnull @.memset_pattern.7, i64 1048576), !tbaa !9
  %6 = call dereferenceable_or_null(262144) ptr @malloc(i64 noundef 262144) #10
  call void @memset_pattern16(ptr %6, ptr nonnull @.memset_pattern.7, i64 262144), !tbaa !9
  %7 = call dereferenceable_or_null(262144) ptr @malloc(i64 noundef 262144) #10
  call void @memset_pattern16(ptr %7, ptr nonnull @.memset_pattern.7, i64 262144), !tbaa !9
  %8 = call dereferenceable_or_null(65536) ptr @malloc(i64 noundef 65536) #10
  call void @memset_pattern16(ptr %8, ptr nonnull @.memset_pattern.7, i64 65536), !tbaa !9
  %9 = call dereferenceable_or_null(262144) ptr @malloc(i64 noundef 262144) #10
  call void @memset_pattern16(ptr %9, ptr nonnull @.memset_pattern.7, i64 262144), !tbaa !9
  %10 = call dereferenceable_or_null(262144) ptr @malloc(i64 noundef 262144) #10
  call void @memset_pattern16(ptr %10, ptr nonnull @.memset_pattern.7, i64 262144), !tbaa !9
