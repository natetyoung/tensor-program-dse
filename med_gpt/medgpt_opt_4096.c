...
void einsum_0(float * restrict L0_Q, float * restrict L0_X, float * restrict L0_WQ) {
    for (int m0 = 0; m0 < 128; m0 += 21) {
        for (int k0 = 0; k0 < 512; k0 += 51) {
            for (int d0 = 0; d0 < 512; d0 += 1) {
                for (int m0_i = 0; m0_i < ((m0 + 21 <= 128) ? 21 : (128 - m0)); m0_i++) {
                    int m = m0 + m0_i;
                    for (int k0_i = 0; k0_i < ((k0 + 51 <= 512) ? 51 : (512 - k0)); k0_i++) {
                        int k = k0 + k0_i;
