...
39:                                               ; preds = %33
  ...
  %41 = sub nsw i32 128, %40
  br label %42

42:                                               ; preds = %39, %38
  %43 = phi i32 [ 21, %38 ], [ %41, %39 ]
...
define i32 @main() #0 {
  ...
  %20 = call ptr @malloc(i64 noundef 262144) #4
...
32:                                               ; preds = %21
  %33 = call ptr @malloc(i64 noundef 1048576) #4
...
45:                                               ; preds = %34
  %46 = call ptr @malloc(i64 noundef 262144) #4
...
58:                                               ; preds = %47
  %59 = call ptr @malloc(i64 noundef 262144) #4
...
71:                                               ; preds = %60
  %72 = call ptr @malloc(i64 noundef 65536) #4
...
84:                                               ; preds = %73
  %85 = call ptr @malloc(i64 noundef 262144) #4
...
97:                                               ; preds = %86
  %98 = call ptr @malloc(i64 noundef 262144) #4
