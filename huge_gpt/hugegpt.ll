; ModuleID = 'huge_gpt/hugegpt.c'
source_filename = "huge_gpt/hugegpt.c"
...
define noundef i32 @main() local_unnamed_addr #3 {
  ...
  call void @memset_pattern16(ptr %4, ptr nonnull @.memset_pattern.7, i64 16777216), !tbaa !9
  %5 = call dereferenceable_or_null(67108864) ptr @malloc(i64 noundef 67108864) #10
  call void @memset_pattern16(ptr %5, ptr nonnull @.memset_pattern.7, i64 67108864), !tbaa !9
  %6 = call dereferenceable_or_null(16777216) ptr @malloc(i64 noundef 16777216) #10
  call void @memset_pattern16(ptr %6, ptr nonnull @.memset_pattern.7, i64 16777216), !tbaa !9
  %7 = call dereferenceable_or_null(16777216) ptr @malloc(i64 noundef 16777216) #10
  call void @memset_pattern16(ptr %7, ptr nonnull @.memset_pattern.7, i64 16777216), !tbaa !9
  %8 = call dereferenceable_or_null(4194304) ptr @malloc(i64 noundef 4194304) #10
  call void @memset_pattern16(ptr %8, ptr nonnull @.memset_pattern.7, i64 4194304), !tbaa !9
  %9 = call dereferenceable_or_null(16777216) ptr @malloc(i64 noundef 16777216) #10
  call void @memset_pattern16(ptr %9, ptr nonnull @.memset_pattern.7, i64 16777216), !tbaa !9
  %10 = call dereferenceable_or_null(16777216) ptr @malloc(i64 noundef 16777216) #10
  call void @memset_pattern16(ptr %10, ptr nonnull @.memset_pattern.7, i64 16777216), !tbaa !9
