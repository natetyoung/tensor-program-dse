...
39:                                               ; preds = %33
  ...
  %41 = sub nsw i32 1024, %40
  br label %42

42:                                               ; preds = %39, %38
  %43 = phi i32 [ 6, %38 ], [ %41, %39 ]
...
34:                                               ; preds = %28
  %35 = load i32, ptr %7, align 4
  %36 = sub nsw i32 1024, %35
  br label %37

37:                                               ; preds = %34, %33
  %38 = phi i32 [ 6, %33 ], [ %36, %34 ]
...
define i32 @main() #0 {
  ...
  %20 = call ptr @malloc(i64 noundef 16777216) #4
...
32:                                               ; preds = %21
  %33 = call ptr @malloc(i64 noundef 67108864) #4
...
45:                                               ; preds = %34
  %46 = call ptr @malloc(i64 noundef 16777216) #4
...
58:                                               ; preds = %47
  %59 = call ptr @malloc(i64 noundef 16777216) #4
...
71:                                               ; preds = %60
  %72 = call ptr @malloc(i64 noundef 4194304) #4
...
84:                                               ; preds = %73
  %85 = call ptr @malloc(i64 noundef 16777216) #4
...
97:                                               ; preds = %86
  %98 = call ptr @malloc(i64 noundef 16777216) #4
