; ModuleID = 'tiny_gpt/tinygpt.c'
source_filename = "tiny_gpt/tinygpt.c"
...
define noundef i32 @main() local_unnamed_addr #3 {
  ...
  call void @memset_pattern16(ptr %4, ptr nonnull @.memset_pattern.7, i64 16384), !tbaa !9
  %5 = call dereferenceable_or_null(65536) ptr @malloc(i64 noundef 65536) #10
  call void @memset_pattern16(ptr %5, ptr nonnull @.memset_pattern.7, i64 65536), !tbaa !9
  %6 = call dereferenceable_or_null(16384) ptr @malloc(i64 noundef 16384) #10
  call void @memset_pattern16(ptr %6, ptr nonnull @.memset_pattern.7, i64 16384), !tbaa !9
  %7 = call dereferenceable_or_null(16384) ptr @malloc(i64 noundef 16384) #10
  call void @memset_pattern16(ptr %7, ptr nonnull @.memset_pattern.7, i64 16384), !tbaa !9
  %8 = call dereferenceable_or_null(4096) ptr @malloc(i64 noundef 4096) #10
  call void @memset_pattern16(ptr %8, ptr nonnull @.memset_pattern.7, i64 4096), !tbaa !9
  %9 = call dereferenceable_or_null(16384) ptr @malloc(i64 noundef 16384) #10
  call void @memset_pattern16(ptr %9, ptr nonnull @.memset_pattern.7, i64 16384), !tbaa !9
  %10 = call dereferenceable_or_null(16384) ptr @malloc(i64 noundef 16384) #10
  call void @memset_pattern16(ptr %10, ptr nonnull @.memset_pattern.7, i64 16384), !tbaa !9
